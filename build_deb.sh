...
#   /usr/lib/kubuno/modules/keestore/{kubuno-keestore, module.toml, frontend/}
#   /usr/share/kubuno/modules/keestore/migrations/*.sql
#   /etc/kubuno/modules/keestore/config.toml.example
#
# Usage :
